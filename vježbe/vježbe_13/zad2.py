...
mars = universe.Cobject(0.107,0,1.52,2*np.pi*0.808, 0)
comet = universe.Cobject(kg(1e14),1-km(6400),0,kms(-27),-2*np.pi)
...
gs = 6  #područje oko sunca kojeg gledamo u AU
